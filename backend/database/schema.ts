...
export class ItemPhotoSchema extends BaseModel {
  static $columns = ['createdAt', 'id', 'itemId', 'photoUrl', 'updatedAt'] as const
  $columns = ItemPhotoSchema.$columns
  @column.dateTime({ autoCreate: true })
  declare createdAt: DateTime | null
  @column({ isPrimary: true })
  declare id: number
...
export class ItemSchema extends BaseModel {
  static $columns = ['categoryId', 'createdAt', 'description', 'folderId', 'id', 'location', 'name', 'price', 'purchaseDate', 'qty', 'updatedAt'] as const
